...
- [[#basics][BASICS]]
  - [[#package-buffer-and-window-management][Package, Buffer and Window management]]
...
** Package, Buffer and Window management
...
** NEEDED? Consult
Consult provides powerful completion and narrowing commands for Emacs. It integrates well with other completion frameworks like Vertico, enabling features like previews and enhanced register management. It's useful for navigating buffers, files, and xrefs with ease.
